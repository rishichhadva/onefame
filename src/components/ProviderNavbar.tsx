    ...
    <nav className="sticky top-4 z-50 mx-auto mt-4 mb-8 w-full max-w-6xl rounded-full border border-white/10 bg-[#050916]/80 px-5 py-3 text-white shadow-lg shadow-black/40 backdrop-blur">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-purple-600 to-cyan-400 shadow-lg shadow-purple-900/40">
        ...
        <div className="hidden items-center gap-3 md:flex">
          {user ? (
            ...
            <>
              ...
              <Link
                className="rounded-full bg-gradient-to-r from-purple-600 to-cyan-400 px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-purple-900/40 transition hover:scale-105"
                to="/auth/Signup"
              >
                Join now
              </Link>
